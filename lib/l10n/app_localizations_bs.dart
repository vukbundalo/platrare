...
class AppLocalizationsBs extends AppLocalizations {
  ...
  @override
  String get widgetHorizonEndOfMonth => 'Kraj mjeseca';
  ...
  @override
  String get widgetDueToday => 'Dospijeva danas';
  ...
  String get widgetDescNumbers =>
      'Prikažite jedan broj: raspoloživo, neto vrijednost ili najnižu tačku ovog mjeseca.';
  ...
  @override
  String get settingsWidgetAmountsTitle => 'Prikaži iznose u widgetima';

  @override
  String get settingsWidgetAmountsSubtitle =>
      'Widgeti na početnom ekranu vidljivi su bez otključavanja aplikacije. Dok je zaključavanje uključeno, iznosi ostaju skriveni osim ako ovo ne uključite.';
  ...
  @override
  String get settingsCsvExportFailed => 'Izvoz CSV-a nije uspio';
  ...
  String get settingsCsvImportSubtitle =>
      'Dodajte transakcije iz tabele — ništa se ne zamjenjuje';
  ...
  String get settingsCsvTemplateSubtitle =>
      'Primjer datoteke u koju možete zalijepiti stare podatke';

  @override
  String get csvTemplateInstruction1 =>
      'Zamijenite primjere redova ispod vlastitim podacima, a zatim uvezite ovu datoteku u Postavkama.';
  ...
  String csvImportPreviewCounts(int importable, int total) {
    return 'Bit će dodano $importable od $total redova';
  }
  ...
  @override
  String get csvImportPreviewDateStyleMonthFirst => 'Prvo mjesec (4. mart)';

  @override
  String get csvImportPreviewNothing =>
      'Nijedan red iz ove datoteke ne može se uvesti.';
  ...
  @override
  String get csvImportFailed => 'Uvoz CSV-a nije uspio';
  ...
  String get settingsSecurityLockDelayTitle =>
      'Ponovo zaključaj nakon pozadine';

  @override
  String get settingsSecurityLockDelaySubtitle =>
      'Koliko dugo aplikacija može biti izvan ekrana prije ponovnog traženja otključavanja. Odmah je najsigurnije.';
  ...
  @override
  String get settingsBackupReminderTitle => 'Podsjetnik za sigurnosnu kopiju';

  @override
  String get settingsBackupReminderSubtitle =>
      'Baner unutar aplikacije ako dodate mnogo transakcija bez izvoza ručne sigurnosne kopije.';
  ...
  String settingsBackupReminderThresholdSubtitle(int count) {
    return 'Podsjeti nakon $count novih transakcija od zadnjeg ručnog izvoza.';
  }

  @override
  String get settingsBackupReminderThresholdInvalid =>
      'Unesite cijeli broj od 1 do 500.';

  @override
  String settingsBackupReminderSnoozeHint(int n) {
    return '\"Podsjeti kasnije\" skriva baner dok ne dodate još $n transakcija.';
  }

  @override
  String get backupReminderBannerTitle => 'Izvesti sigurnosnu kopiju?';

  @override
  String backupReminderBannerBody(int count) {
    return 'Dodali ste $count transakcija od zadnjeg ručnog izvoza.';
  }
  ...
  String get backupExportLedgerVerifyInfo =>
      'Uspoređuje pohranjeni saldo svakog računa s potpunom reprodukcijom vaše povijesti. U svakom slučaju možete izvesti sigurnosnu kopiju; nepodudaranja su informativna.';
  ...
  String get helpTrackHeroBody =>
      'Ova kartica sabira prilive i odlive za listu ispod. Čipovi filtriraju po računu, kategoriji i tipu; čip datuma mijenja dan, sedmicu, mjesec i godinu; strelica obrće redoslijed sortiranja.';

  @override
  String get helpTrackListTitle => 'Vaša historija';

  @override
  String get helpTrackListBody =>
      'Zabilježene transakcije, grupisane po danima. Dodirnite neku da je pogledate ili izmijenite, a pretragom pronađite određeni unos.';
  ...
  String get helpSettingsBody =>
      'Valute, jezik, tema, sigurnost, rezervne kopije i upravljanje računima nalaze se ovdje.';
  ...
  String get helpPlanListBody =>
      'Očekivani prihodi, troškovi i transferi. Dodirnite stavku da je izmijenite; čipovi na vrhu filtriraju ovu listu.';
  ...
  String get helpPlanProjectionFabBody =>
      'Dodirnite globus da izaberete budući datum i vidite projektovana stanja — primjenjuju se planirane transakcije do tog datuma. Možete i dodirnuti datum na kartici iznad.';
  ...
  String get helpReviewHeroBody =>
      'Vaš lični saldo i neto vrijednost na prvi pogled. Dodirnite iznose da promijenite osnovnu i sekundarnu valutu.';
  ...
  String get helpReviewSectionsBody =>
      'Prevlačite lijevo i desno — ili dodirujte čipove — da se krećete između ličnih računa, osoba, entiteta i statistike.';
  ...
  String get helpReviewAccountsBody =>
      'Svaka kartica prikazuje račun i njegov saldo. Dodirnite je da otvorite cijelu historiju transakcija.';
  ...
  String get helpReviewFabBody =>
      'Napravite račune za gotovinu, kartice i štednju, ili za osobe i firme koje pratite.';
  ...
  String get helpSettingsManageBody =>
      'Izmijenite račune i preimenujte kategorije — promjene važe svuda u aplikaciji.';
  ...
  String get helpTxAccountsBody =>
      'Izaberite odakle novac dolazi i kuda ide. Samo Sa: trošak. Samo Na: prihod. Oba: transfer između računa.';
  ...
  String get helpTxDetailsBody =>
      'Unesite iznos, zatim dodajte kategoriju, bilješku ili prilog da biste unos kasnije lako pronašli.';
  ...
  String get helpPlannedDateBody =>
      'Dodirnite ovdje da izaberete kada ovo treba da se desi. Plan se može i ponavljati po rasporedu koji izaberete.';
  ...
  String get helpPlannedProjectionBody =>
      'Birači računa prikazuju projektovano stanje svakog računa na datum dospijeća, pa lako uočite plan koji bi račun odveo u minus.';

  @override
  String get settingsPlannedRemindersTitle => 'Podsjetnici za planove';

  @override
  String get settingsPlannedRemindersSubtitle =>
      'Obavještava vas kada planirana transakcija dospijeva. Radi potpuno offline — ništa ne napušta vaš uređaj.';

  @override
  String get settingsPlannedRemindersTimeTitle => 'Vrijeme podsjetnika';

  @override
  String get settingsPlannedRemindersLeadTitle => 'Najava unaprijed';

  @override
  String get settingsPlannedRemindersLeadOnDay => 'Na dan dospijeća';
  ...
  String get settingsPlannedRemindersPermissionDenied =>
      'Obavještenja su isključena za Platrare. Dozvolite ih u postavkama sistema da biste primali podsjetnike.';

  @override
  String get plannedReminderChannelName =>
      'Podsjetnici za planirane transakcije';

  @override
  String get plannedReminderChannelDescription =>
      'Obavještenja o nadolazećim planiranim transakcijama.';

  @override
  String get plannedReminderFallbackTitle => 'Planirana transakcija';

  @override
  String get plannedReminderDueToday => 'Dospijeva danas';

  @override
  String get plannedReminderDueTomorrow => 'Dospijeva sutra';
  ...
  String plannedReminderDueInDays(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Dospijeva za $count dana',
      few: 'Dospijeva za $count dana',
