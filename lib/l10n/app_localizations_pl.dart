...
class AppLocalizationsPl extends AppLocalizations {
  ...
  @override
  String get widgetLowestPoint => 'Najniższy punkt';

  @override
  String get widgetProjected => 'Prognoza';

  @override
  String get widgetHorizonIn7Days => 'Za 7 dni';

  @override
  String get widgetHorizonEndOfMonth => 'Koniec miesiąca';

  @override
  String get widgetMetricAccount => 'Saldo konta';

  @override
  String get widgetQuickAdd => 'Szybkie dodawanie';

  @override
  String get widgetStale => 'Dane mogą być nieaktualne';

  @override
  String get widgetOpenToStart => 'Otwórz Platrare, aby dodać konta';

  @override
  String get widgetDueToday => 'Termin dzisiaj';

  @override
  String get widgetDescQuickAdd =>
      'Dodaj transakcję lub plan jednym dotknięciem.';
  ...
  String get widgetDescNumbers =>
      'Pokaż jedną liczbę: dostępne środki, wartość netto lub najniższy punkt w tym miesiącu.';

  @override
  String get widgetConfigMetric => 'Wskaźnik';

  @override
  String get widgetConfigHorizon => 'Horyzont';

  @override
  String widgetSiriAddTransaction(String appName) {
    return 'Dodaj transakcję w $appName';
  }

  @override
  String widgetSiriAddPlanned(String appName) {
    return 'Dodaj zaplanowaną transakcję w $appName';
  }

  @override
  String get settingsWidgetAmountsTitle => 'Pokazuj kwoty w widżetach';

  @override
  String get settingsWidgetAmountsSubtitle =>
      'Widżety na ekranie głównym są widoczne bez odblokowania aplikacji. Przy włączonej blokadzie kwoty pozostają ukryte, chyba że włączysz tę opcję.';
  ...
  @override
  String get settingsCsvExportTitle => 'Eksportuj jako CSV';

  @override
  String get settingsCsvExportSubtitle =>
      'Twoje transakcje jako plik arkusza kalkulacyjnego';

  @override
  String get settingsCsvExportFailed => 'Eksport CSV nie powiódł się';

  @override
  String get settingsCsvImportTitle => 'Importuj z CSV';

  @override
  String get settingsCsvImportSubtitle =>
      'Dodaj transakcje z arkusza kalkulacyjnego — nic nie zostaje zastąpione';

  @override
  String get settingsCsvTemplateTitle => 'Pobierz szablon CSV';

  @override
  String get settingsCsvTemplateSubtitle =>
      'Przykładowy plik, do którego wkleisz stare dane';

  @override
  String get csvTemplateInstruction1 =>
      'Zastąp poniższe przykładowe wiersze własnymi danymi, a następnie zaimportuj ten plik w Ustawieniach.';

  @override
  String get csvTemplateInstruction2 =>
      'Pola date i amount są wymagane. Daty zapisuj jako YYYY-MM-DD, a kwoty jako liczbę dodatnią.';

  @override
  String get csvTemplateInstruction3 =>
      'Pole type może mieć wartość income, expense, transfer, invoice, bill, advance, settlement, loan, collection lub offset. Zostaw puste, aby aplikacja ustaliła typ na podstawie kont.';

  @override
  String get csvTemplateInstruction4 =>
      'Konta i kategorie, które jeszcze nie istnieją, zostaną utworzone automatycznie. Wiersze zaczynające się od # są pomijane.';

  @override
  String get csvImportPreviewTitle => 'Importuj transakcje';

  @override
  String csvImportPreviewCounts(int importable, int total) {
    return 'Zostanie dodanych $importable z $total wierszy';
  }

  @override
  String csvImportPreviewNewAccounts(String names) {
    return 'Nowe konta: $names';
  }

  @override
  String csvImportPreviewNewCategories(String names) {
    return 'Nowe kategorie: $names';
  }
  ...
  String csvImportPreviewDuplicates(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count wiersza już istnieje',
      many: '$count wierszy już istnieje',
      few: '$count wiersze już istnieją',
      one: '$count wiersz już istnieje',
    );
    return '$_temp0';
  }
  ...
  String get csvImportPreviewSkipDuplicates =>
      'Pomijaj wiersze, które już istnieją';
  ...
  String csvImportPreviewIssuesTitle(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Nie udało się odczytać $count wiersza',
      many: 'Nie udało się odczytać $count wierszy',
      few: 'Nie udało się odczytać $count wierszy',
      one: 'Nie udało się odczytać $count wiersza',
    );
    return '$_temp0';
  }
  ...
  String get csvImportPreviewDateStyleTitle =>
      'Daty takie jak 03/04/2026 są niejednoznaczne. Jak je odczytać?';

  @override
  String get csvImportPreviewDateStyleDayFirst => 'Najpierw dzień (3 kwietnia)';

  @override
  String get csvImportPreviewDateStyleMonthFirst =>
      'Najpierw miesiąc (4 marca)';

  @override
  String get csvImportPreviewNothing =>
      'Żadnego wiersza z tego pliku nie można zaimportować.';

  @override
  String get csvImportPreviewConfirm => 'Importuj';

  @override
  String get csvRowProblemDate => 'nieprawidłowa lub brakująca data';

  @override
  String get csvRowProblemAmount => 'nieprawidłowa lub brakująca kwota';

  @override
  String get csvRowProblemAccount => 'nieprawidłowe lub brakujące konto';

  @override
  String get csvRowProblemType => 'nieznany typ transakcji';
  ...
  String csvImportDone(num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: 'Zaimportowano $count transakcję',
    );
    return '$_temp0';
  }
  ...
  String get csvImportFailedNoColumns =>
      'Nie rozpoznano żadnej kolumny. Zacznij od szablonu CSV.';

  @override
  String csvImportFailedMissingColumn(String column) {
    return 'Plik nie ma kolumny \"$column\".';
  }

  @override
  String get csvImportFailedEmpty => 'Ten plik nie zawiera wierszy z danymi.';

  @override
  String csvImportFailedTooManyRows(int rows, int max) {
    return 'Ten plik ma $rows wierszy; limit to $max.';
  }

  @override
  String get csvImportFailed => 'Import CSV nie powiódł się';
  ...
  @override
  String get categorySave => 'Zapisz';

  @override
  String get categoryRenameAction => 'Zmień nazwę';

  @override
  String get categoryDuplicateName => 'Kategoria o tej nazwie już istnieje.';

  @override
  String get categoryInUseTitle => 'Kategoria w użyciu';
  ...
  String categoryInUseBody(String category, num count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      one: '$count transakcję',
    );
    return '„$category” jest używana przez $_temp0. Nie można jej usunąć, ale można zmienić jej nazwę — wszystkie powiązane transakcje zostaną zaktualizowane automatycznie.';
  }
  ...
  @override
  String get helpNext => 'Dalej';

  @override
  String get helpBack => 'Wstecz';

  @override
  String get helpDone => 'Gotowe';

  @override
  String get helpSkip => 'Pomiń';

  @override
  String get helpTrackHeroTitle => 'Sumy i filtry';

  @override
  String get helpTrackHeroBody =>
      'Ta karta sumuje wpływy i wydatki dla listy poniżej. Chipy filtrują według konta, kategorii i typu; chip daty przełącza dzień, tydzień, miesiąc i rok; strzałka odwraca kolejność sortowania.';

  @override
  String get helpTrackListTitle => 'Twoja historia';

  @override
  String get helpTrackListBody =>
      'Zarejestrowane transakcje pogrupowane według dni. Dotknij, aby zobaczyć lub edytować, a wyszukiwarka pomoże znaleźć konkretny wpis.';

  @override
  String get helpTrackFabTitle => 'Dodaj transakcję';

  @override
  String get helpTrackFabBody =>
      'Rejestruj pieniądze przychodzące, wychodzące lub przenoszone między kontami.';

  @override
  String get helpSettingsTitle => 'Ustawienia';

  @override
  String get helpSettingsBody =>
      'Waluty, język, motyw, bezpieczeństwo, kopie zapasowe i zarządzanie kontami znajdziesz tutaj.';

  @override
  String get helpPlanHeroTitle => 'Prognoza';

  @override
  String get helpPlanHeroBody =>
      'Twoje saldo osobiste i netto na wybraną datę. Chipy poniżej filtrują planowane transakcje.';

  @override
  String get helpPlanListTitle => 'Planowane transakcje';

  @override
  String get helpPlanListBody =>
      'Oczekiwane wpływy, wydatki i przelewy. Dotknij pozycji, aby ją edytować; chipy u góry filtrują tę listę.';
  ...
  String get helpPlanFabBody =>
      'Zaplanuj spodziewaną transakcję, także cykliczną.';

  @override
  String get helpPlanProjectionFabTitle => 'Prognozuj przyszłość';

  @override
  String get helpPlanProjectionFabBody =>
      'Dotknij globusa, aby wybrać przyszłą datę i zobaczyć prognozowane salda — uwzględniane są planowane transakcje do tej daty. Możesz też dotknąć daty na karcie u góry.';

  @override
  String get helpReviewHeroTitle => 'Wartość netto';

  @override
  String get helpReviewHeroBody =>
      'Twoje saldo osobiste i wartość netto w skrócie. Dotknij kwot, aby przełączyć walutę podstawową i dodatkową.';

  @override
  String get helpReviewSectionsTitle => 'Sekcje';

  @override
  String get helpReviewSectionsBody =>
      'Przesuwaj w lewo i w prawo — lub dotykaj chipów — aby przechodzić między kontami osobistymi, osobami, podmiotami i statystykami.';

  @override
  String get helpReviewAccountsTitle => 'Konta';

  @override
  String get helpReviewAccountsBody =>
      'Każda karta pokazuje konto i jego saldo. Dotknij, aby otworzyć pełną historię transakcji.';

  @override
  String get helpReviewFabTitle => 'Dodaj konto';

  @override
  String get helpReviewFabBody =>
      'Twórz konta na gotówkę, karty i oszczędności albo dla osób i firm, które śledzisz.';

  @override
  String get helpSettingsSecurityTitle => 'Bezpieczeństwo';

  @override
  String get helpSettingsSecurityBody =>
      'Zablokuj aplikację blokadą ekranu urządzenia i wybierz, jak szybko blokuje się ponownie.';

  @override
  String get helpSettingsPreferencesTitle => 'Preferencje';

  @override
  String get helpSettingsPreferencesBody =>
      'Język, motyw, waluty i inne codzienne opcje.';

  @override
  String get helpSettingsDataTitle => 'Twoje dane';

  @override
  String get helpSettingsDataBody =>
      'Eksportuj zaszyfrowane kopie zapasowe, importuj je na innym urządzeniu i konfiguruj kopie automatyczne. Twoje dane pozostają na tym urządzeniu, dopóki ich nie wyeksportujesz.';

  @override
  String get helpSettingsManageTitle => 'Zarządzanie';

  @override
  String get helpSettingsManageBody =>
      'Edytuj konta i zmieniaj nazwy kategorii — zmiany obowiązują w całej aplikacji.';

  @override
  String get helpTxAccountsTitle => 'Z i Do';

  @override
  String get helpTxAccountsBody =>
      'Wybierz, skąd pochodzą pieniądze i dokąd trafiają. Tylko Z: wydatek. Tylko Do: wpływ. Oba: przelew między kontami.';

  @override
  String get helpTxDetailsTitle => 'Kwota i szczegóły';

  @override
  String get helpTxDetailsBody =>
      'Wpisz kwotę, a następnie dodaj kategorię, notatkę lub załącznik, aby łatwo odnaleźć wpis później.';

  @override
  String get helpTxDateTitle => 'Data';

  @override
  String get helpTxDateBody => 'Dotknij tutaj, aby zmienić dzień transakcji.';

  @override
  String get helpPlannedDateTitle => 'Termin';

  @override
  String get helpPlannedDateBody =>
      'Dotknij tutaj, aby wybrać, kiedy to ma nastąpić. Plan może też powtarzać się według wybranego harmonogramu.';

  @override
  String get helpPlannedProjectionTitle => 'Prognozowane salda';

  @override
  String get helpPlannedProjectionBody =>
      'Wybór kont pokazuje prognozowane saldo każdego konta na dzień terminu, dzięki czemu dostrzeżesz plan, który zdebetowałby konto.';

  @override
  String get settingsPlannedRemindersTitle => 'Przypomnienia o planach';

  @override
  String get settingsPlannedRemindersSubtitle =>
      'Powiadamia, gdy nadchodzi termin zaplanowanej transakcji. Działa całkowicie offline — nic nie opuszcza urządzenia.';

  @override
  String get settingsPlannedRemindersTimeTitle => 'Godzina przypomnienia';

  @override
  String get settingsPlannedRemindersLeadTitle => 'Wyprzedzenie';

  @override
  String get settingsPlannedRemindersLeadOnDay => 'W dniu terminu';
  ...
  String get settingsPlannedRemindersPermissionDenied =>
      'Powiadomienia dla Platrare są wyłączone. Zezwól na nie w ustawieniach systemu, aby otrzymywać przypomnienia.';

  @override
  String get plannedReminderChannelName =>
      'Przypomnienia o zaplanowanych transakcjach';

  @override
  String get plannedReminderChannelDescription =>
      'Powiadomienia o nadchodzących zaplanowanych transakcjach.';

  @override
  String get plannedReminderFallbackTitle => 'Zaplanowana transakcja';

  @override
  String get plannedReminderDueToday => 'Termin dzisiaj';

  @override
  String get plannedReminderDueTomorrow => 'Termin jutro';
  ...
  String plannedReminderDueInDays(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: 'Termin za $count dnia',
      many: 'Termin za $count dni',
      few: 'Termin za $count dni',
      one: 'Termin za $count dzień',
    );
    return '$_temp0';
  }

  @override
  String get aboutContactSupport => 'Skontaktuj się z pomocą';

  @override
  String get aboutSupportEmailCopied => 'Skopiowano adres e-mail pomocy';

  @override
  String get onboardingWelcomeTitle => 'Witaj w Platrare';

  @override
  String get onboardingWelcomeBody =>
      'Twoje pieniądze zostają na tym urządzeniu. Bez konta, bez reklam, bez śledzenia.';

  @override
  String get onboardingPlanBody =>
      'Zaplanuj nadchodzące i cykliczne płatności i zobacz, dokąd zmierzają Twoje salda.';

  @override
  String get onboardingTrackBody =>
      'Zapisuj przychody, wydatki, przelewy oraz to, co pożyczasz lub jesteś winien.';

  @override
  String get onboardingReviewBody =>
      'Statystyki, porównania i historia dla Twoich kont, osób, z którymi się rozliczasz, i firm.';

  @override
  String get onboardingCurrencyLabel => 'Waluta podstawowa';

  @override
  String get onboardingCurrencyHint =>
      'Zaproponowana na podstawie języka urządzenia. Możesz ją później zmienić w Ustawieniach.';
  ...
  @override
  String get semanticsPreviousPeriod => 'Poprzedni okres';

  @override
  String get semanticsNextPeriod => 'Następny okres';

  @override
  String get semanticsSectionStatistics => 'Statystyki';

  @override
  String get semanticsCurrencyToggle => 'Zmień walutę wyświetlania';

  @override
  String get semanticsStatsSpent => 'Wydano';
