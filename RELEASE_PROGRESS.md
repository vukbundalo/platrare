...
| 6 | Enums for section / stats / period / type-group state | [~] | Period done (`PeriodUnit`). Remaining: Review section/stats strings, `_spendingMonths` magic ints, the three `_kType*`/`_inGroup` copies. |
